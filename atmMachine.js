...
var StartStop;
(function (StartStop) {
    StartStop["Perform_Another_Transaction"] = "Perform Another Transaction";
    StartStop["End_Transaction"] = "End Transaction";
})(StartStop || (StartStop = {}));
;
var Action;
(function (Action) {
    Action["Check_Account_Balance"] = "Check Account Balance";
    Action["Withdraw_Money"] = "Withdraw Money";
    Action["Check_Previous_transaction"] = "Check Previous Transactions";
})(Action || (Action = {}));
;
var loginDetails = [{
        type: "number",
...
var answer = await inquirer.prompt(loginDetails);
...
if (logIn) {
    ...
    do {
        var choices = await inquirer.prompt(action);
        ...
        ;
        var continueTransaction = await inquirer.prompt(startStop);
